...
class FertilizerChart extends StatefulWidget {
  const FertilizerChart({super.key});
  @override
  State<StatefulWidget> createState() => FertilizerChartState();
}
...
class FertilizerChartState extends State<FertilizerChart> {
  ...
  BarChartGroupData makeGroupData(
    ...
    double rpmCurrent =
        motorState.rpm[fertilizer['addressedLayout'][x - 1] - 1];
          ...
          color: error == 2
              ...
              : error == 1
                  ...
                  : error == 0
                      ? kSuccessColor
                      : kSecondaryColor,
          width: 16 * fertilizer["layout"][x - 1] +
              Charts.getGroupSpace() * (fertilizer["layout"][x - 1] - 1),
        ),
      ],
  ...
  BarChartData randomData() {
    return BarChartData(
      ...
      barGroups: List.generate(fertilizer["layout"].length, (i) {
        switch (i + 1) {
          case 1:
